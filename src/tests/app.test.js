...
import App from '../App';
import leaguesReducer, { fetchLeaguesAction } from '../redux/teams/teams_reducer';
...
const mockLoadLeagues = () => (fetchLeaguesAction(mockApiData));
...
describe('Redux store tests:', () => {
  ...
  it('fetchLeagesAction should be dispatched correctly', () => {
    act(() => {
